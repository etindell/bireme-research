...
from apps.compliance.models import ComplianceTaskTemplate, ComplianceSettings
...
TEMPLATES = [
    ...
    # QUARTERLY CODE OF ETHICS
    {'title': 'Code of Ethics: Quarterly transactions report (Q4)', 'description': 'Collect and review Q4 personal securities transaction reports from access persons.', 'frequency': 'QUARTERLY', 'quarter': 4, 'default_due_month': 1, 'default_due_day': 30, 'tags': 'quarterly,code-of-ethics', 'owner_role': 'CCO', 'suggested_evidence': 'Report PDF; attestation note.'},
    {'title': 'Code of Ethics: Quarterly transactions report (Q1)', 'description': 'Collect and review Q1 personal securities transaction reports from access persons.', 'frequency': 'QUARTERLY', 'quarter': 1, 'default_due_month': 4, 'default_due_day': 30, 'tags': 'quarterly,code-of-ethics', 'owner_role': 'CCO', 'suggested_evidence': 'Report PDF; attestation note.'},
    {'title': 'Code of Ethics: Quarterly transactions report (Q2)', 'description': 'Collect and review Q2 personal securities transaction reports from access persons.', 'frequency': 'QUARTERLY', 'quarter': 2, 'default_due_month': 7, 'default_due_day': 30, 'tags': 'quarterly,code-of-ethics', 'owner_role': 'CCO', 'suggested_evidence': 'Report PDF; attestation note.'},
    {'title': 'Code of Ethics: Quarterly transactions report (Q3)', 'description': 'Collect and review Q3 personal securities transaction reports from access persons.', 'frequency': 'QUARTERLY', 'quarter': 3, 'default_due_month': 10, 'default_due_day': 30, 'tags': 'quarterly,code-of-ethics', 'owner_role': 'CCO', 'suggested_evidence': 'Report PDF; attestation note.'},
    # QUARTERLY MARKETING
    ...
    {'title': 'Annual: BCP drill + cybersecurity tabletop', 'description': 'Conduct business continuity plan drill and cybersecurity tabletop exercise.', 'frequency': 'ANNUAL', 'default_due_month': 6, 'default_due_day': 30, 'tags': 'annual,bcp,cybersecurity', 'owner_role': 'CCO', 'suggested_evidence': 'Drill results; attendee notes.'},
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for tpl_data in TEMPLATES:
            ...
            _, was_created = ComplianceTaskTemplate.objects.get_or_create(
                organization=org,
                title=title,
                defaults=tpl_data,
            )
