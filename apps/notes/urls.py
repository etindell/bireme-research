...
urlpatterns = [
    ...
    path('autosave/', views.NoteAutoSaveView.as_view(), name='autosave_new'),
    path('autosave/<int:pk>/', views.NoteAutoSaveView.as_view(), name='autosave'),
    ...
    path('<int:pk>/history/', views.NoteHistoryListView.as_view(), name='history'),
    path('<int:pk>/revert/<int:history_pk>/', views.NoteRevertView.as_view(), name='revert'),
