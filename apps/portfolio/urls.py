...
urlpatterns = [
    ...
    path('<int:pk>/set-default-irr/', views.PortfolioSetDefaultIRRView.as_view(), name='set_default_irr'),
    path('<int:pk>/add-position/', views.PortfolioAddPositionView.as_view(), name='add_position'),
